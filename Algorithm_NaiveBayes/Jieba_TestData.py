...
commList_Jieba = []
with open("E:/AB104/Ctrip/20170107_Ctrip_Info_ALL.json", 'r') as a:
...
with open("E:/AB104/AlgorithmTest/Jieba_TestData_Ctrip.json","w") as w:
    w.write(commList_Jieba_marked_json.encode("utf-8"))

s2 = datetime.now()
print "All  Finish "+str(s2-s1)+"!!"
# All  Finish 0:00:44.921000!!
